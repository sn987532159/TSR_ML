...
## input dataset
tsr_train_x = tsr_train.drop(["icase_id", "idcase_id", "mrs_tx_1", "mrs_tx_3", "CHANGE"], axis=1).reset_index(drop=True)
print(tsr_train_x.shape)

tsr_validation_x = tsr_validation.drop(["icase_id", "idcase_id", "mrs_tx_1", "mrs_tx_3", "CHANGE"], axis=1).reset_index(drop=True)
print(tsr_validation_x.shape)

tsr_test_x = tsr_test.drop(["icase_id", "idcase_id", "mrs_tx_1", "mrs_tx_3", "CHANGE"], axis=1).reset_index(drop=True)
...
csv_save = os.path.join("..", "data", "LINKED_DATA", "TSR_ALL", "TSR_ALL3", "TSR_ALL3_y_TRAIN.csv")
pd.DataFrame(tsr_train_y).to_csv(csv_save, index=False)

csv_save = os.path.join("..", "data", "LINKED_DATA", "TSR_ALL", "TSR_ALL3", "TSR_ALL3_y_VALIDATION.csv")
pd.DataFrame(tsr_validation_y).to_csv(csv_save, index=False)

csv_save = os.path.join("..", "data", "LINKED_DATA", "TSR_ALL", "TSR_ALL3", "TSR_ALL3_y_TEST.csv")
...
csv_save = os.path.join("..", "data", "LINKED_DATA", "TSR_ALL", "TSR_ALL3", "TSR_ALL3_X_TRAIN.csv")
...
csv_save = os.path.join("..", "data", "LINKED_DATA", "TSR_ALL", "TSR_ALL3", "TSR_ALL3_X_VALIDATION.csv")
...
csv_save = os.path.join("..", "data", "LINKED_DATA", "TSR_ALL", "TSR_ALL3", "TSR_ALL3_X_TEST.csv")
