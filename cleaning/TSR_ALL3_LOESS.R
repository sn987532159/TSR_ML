...
file_path <- pathJoin("..", "data", "LINKED_DATA", "TSR_ALL", "TSR_ALL3", "TSR_ALL3_score.csv")
...
file_path <- pathJoin("..", "data", "LINKED_DATA", "TSR_ALL", "TSR_ALL3", "TSR_ALL3_score_cleaned.csv")
TSR_ALL3 <- read.csv(file_path)
