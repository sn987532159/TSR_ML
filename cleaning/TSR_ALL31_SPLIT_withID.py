...
column_names_B = ["idcase_id", "1-month mRS", "Height", "Weight", "GCS-E", "GCS-V", "GCS-M", "Systolic BP", "Diastolic BP",
...
column_names_G.remove("Cancer history unknown")
...
## input dataset
G_X_train = G_train.drop(["icase_id", "mrs_tx_3", "CHANGE"], axis=1)
print(G_X_train.shape)

G_X_validation = G_validation.drop(["icase_id", "mrs_tx_3", "CHANGE"], axis=1)
print(G_X_validation.shape)

G_X_test = G_test.drop(["icase_id", "mrs_tx_3", "CHANGE"], axis=1)
...
csv_save = os.path.join("..", "data", "LINKED_DATA", "TSR_ALL", "TSR_ALL31", "TSR_ALL31G_y_TRAIN_withID.csv")
pd.DataFrame(G_y_train).to_csv(csv_save, index=False)

csv_save = os.path.join("..", "data", "LINKED_DATA", "TSR_ALL", "TSR_ALL31", "TSR_ALL31G_y_VALIDATION_withID.csv")
pd.DataFrame(G_y_validation).to_csv(csv_save, index=False)

csv_save = os.path.join("..", "data", "LINKED_DATA", "TSR_ALL", "TSR_ALL31", "TSR_ALL31G_y_TEST_withID.csv")
...
csv_save = os.path.join("..", "data", "LINKED_DATA", "TSR_ALL", "TSR_ALL31", "TSR_ALL31G_X_TRAIN_withID.csv")
...
csv_save = os.path.join("..", "data", "LINKED_DATA", "TSR_ALL", "TSR_ALL31", "TSR_ALL31G_X_VALIDATION_withID.csv")
...
csv_save = os.path.join("..", "data", "LINKED_DATA", "TSR_ALL", "TSR_ALL31", "TSR_ALL31G_X_TEST_withID.csv")
...
## input dataset
B_X_train = B_train.drop(["icase_id", "mrs_tx_3", "CHANGE"], axis=1)
print(B_X_train.shape)

B_X_validation = B_validation.drop(["icase_id", "mrs_tx_3", "CHANGE"], axis=1)
print(B_X_validation.shape)

B_X_test = B_test.drop(["icase_id", "mrs_tx_3", "CHANGE"], axis=1)
...
csv_save = os.path.join("..", "data", "LINKED_DATA", "TSR_ALL", "TSR_ALL31", "TSR_ALL31B_y_TRAIN_withID.csv")
pd.DataFrame(B_y_train).to_csv(csv_save, index=False)

csv_save = os.path.join("..", "data", "LINKED_DATA", "TSR_ALL", "TSR_ALL31", "TSR_ALL31B_y_VALIDATION_withID.csv")
pd.DataFrame(B_y_validation).to_csv(csv_save, index=False)

csv_save = os.path.join("..", "data", "LINKED_DATA", "TSR_ALL", "TSR_ALL31", "TSR_ALL31B_y_TEST_withID.csv")
...
csv_save = os.path.join("..", "data", "LINKED_DATA", "TSR_ALL", "TSR_ALL31", "TSR_ALL31B_X_TRAIN_withID.csv")
...
csv_save = os.path.join("..", "data", "LINKED_DATA", "TSR_ALL", "TSR_ALL31", "TSR_ALL31B_X_VALIDATION_withID.csv")
...
csv_save = os.path.join("..", "data", "LINKED_DATA", "TSR_ALL", "TSR_ALL31", "TSR_ALL31B_X_TEST_withID.csv")
