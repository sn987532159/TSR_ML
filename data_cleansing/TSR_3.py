...
os.chdir('C:/Users/Jacky C/PycharmProjects/tsr_ml/data_cleansing')
...
location_id_1 = tsr_3.loc[:, "location_id_1"]
# print(location_id_1)
...
fluorg_id_1 = tsr_3.loc[:, "fluorg_id_1"]
# print(fluorg_id_1)
...
verscich_id_1 = tsr_3.loc[:, 'verscich_id_1']
...
versorg_id_1 = tsr_3.loc[:, 'versorg_id_1']
# print(versorg_id_1)
...
veihd_fl_1 = tsr_3.loc[:, 'veihd_fl_1']
# print(veihd_fl_1)
...
veihd_id_1 = tsr_3.loc[:, 'veihd_id_1']
# print(veihd_id_1)
...
veihd_dt_1 = tsr_3.loc[:, 'veihd_dt_1']
...
veihdorg_id_1 = tsr_3.loc[:, 'veihdorg_id_1']
# print(veihdorg_id_1)
...
location_id_3 = tsr_3.loc[:, "location_id_3"]
# print(location_id_3)
...
fluorg_id_3 = tsr_3.loc[:, "fluorg_id_3"]
# print(fluorg_id_3)
...
verscich_id_3 = tsr_3.loc[:, 'verscich_id_3']
...
versorg_id_3 = tsr_3.loc[:, 'versorg_id_3']
# print(versorg_id_3)
...
veihd_fl_3 = tsr_3.loc[:, 'veihd_fl_3']
# print(veihd_fl_3)
...
veihd_id_3 = tsr_3.loc[:, 'veihd_id_3']
# print(veihd_id_3)
...
veihd_dt_3 = tsr_3.loc[:, 'veihd_dt_3']
...
veihdorg_id_3 = tsr_3.loc[:, 'veihdorg_id_3']
# print(veihdorg_id_3)
...
onset_time = tsr_3.loc[:, ["onset_dt", "onseth_nm", "onsetm_nm"]]
...
ot_time = tsr_3.loc[:, ["ot_dt", "ottih_nm", "ottim_nm"]]
...
flook_time = tsr_3.loc[:, ["flook_dt", "flookh_nm", "flookm_nm"]]
...
fct_time = tsr_3.loc[:, ["fct_dt", "fcth_nm", "fctm_nm"]]
...
ivtpath_id = tsr_3.loc[:, "ivtpath_id"]
...
ivtpa_time = tsr_3.loc[:, ["ivtpa_dt", "ivtpah_nm", "ivtpam_nm"]]
...
ivtpamg_nm = tsr_3.loc[:, "ivtpamg_nm"]
...
nivtpa1_fl = tsr_3.loc[:, "nivtpa1_fl"]
...
nivtpa2_fl = tsr_3.loc[:, "nivtpa2_fl"]
...
nivtpa3_fl = tsr_3.loc[:, "nivtpa3_fl"]
...
nivtpa4_fl = tsr_3.loc[:, "nivtpa4_fl"]
...
nivtpa5_fl = tsr_3.loc[:, "nivtpa5_fl"]
...
nivtpa6_fl = tsr_3.loc[:, "nivtpa6_fl"]
...
nivtpa7_fl = tsr_3.loc[:, "nivtpa7_fl"]
...
nivtpa8_fl = tsr_3.loc[:, "nivtpa8_fl"]
...
nivtpa9_fl = tsr_3.loc[:, "nivtpa9_fl"]
...
nivtpa10_fl = tsr_3.loc[:, "nivtpa10_fl"]
...
nivtpa11_fl = tsr_3.loc[:, "nivtpa11_fl"]
...
nivtpa99_fl = tsr_3.loc[:, "nivtpa99_fl"]
...
toastle_fl = tsr_3.loc[:, "toastle_fl"]
...
toastli_fl = tsr_3.loc[:, "toastli_fl"]
...
toastsce_fl = tsr_3.loc[:, "toastsce_fl"]
...
toastsmo_fl = tsr_3.loc[:, "toastsmo_fl"]
...
toastsra_fl = tsr_3.loc[:, "toastsra_fl"]
...
toastsdi_fl = tsr_3.loc[:, "toastsdi_fl"]
...
toastsmi_fl = tsr_3.loc[:, "toastsmi_fl"]
...
toastsantip_fl = tsr_3.loc[:, "toastsantip_fl"]
...
toastsau_fl = tsr_3.loc[:, "toastsau_fl"]
...
toastshy_fl = tsr_3.loc[:, "toastshy_fl"]
...
toastspr_fl = tsr_3.loc[:, "toastspr_fl"]
...
toastsantit_fl = tsr_3.loc[:, "toastsantit_fl"]
...
toastsho_fl = tsr_3.loc[:, "toastsho_fl"]
...
toastshys_fl = tsr_3.loc[:, "toastshys_fl"]
...
toastsca_fl = tsr_3.loc[:, "toastsca_fl"]
...
toastso_fl = tsr_3.loc[:, "toastso_fl"]
...
omliot2_fl = tsr_3.loc[:, "omliot2_fl"]
...
amliot2_fl = tsr_3.loc[:, "amliot2_fl"]
...
ct_time = tsr_3.loc[:, ["ct_dt", "cth_nm", "ctm_nm"]]
...
mri_time = tsr_3.loc[:, ["mri_dt", "mrih_nm", "mrim_nm"]]
...
nihsin_time = tsr_3.loc[:, ["nihsin_dt", "nihsinh_nm", "nihsinm_nm"]]
...
nihsinh_nm = tsr_3.loc[:, "nihsinh_nm"]
...
nihsinm_nm = tsr_3.loc[:, "nihsinm_nm"]
...
nihsoth_nm = tsr_3.loc[:, "nihsoth_nm"]
...
nihsotm_nm = tsr_3.loc[:, "nihsotm_nm"]
...
platelet_nm = tsr_3.loc[:, "platelet_nm"]
...
offdtorg_id = tsr_3.loc[:, "offdtorg_id"]
# print(offdtorg_id)
...
toilet_use = tsr_3.loc[:, "toilet_use"]
...
bowel_control = tsr_3.loc[:, "bowel_control"]
...
bladder_control = tsr_3.loc[:, "bladder_control"]
...
discharged_mrs = tsr_3.loc[:, "discharged_mrs"]
...
cortical_aca_ctr = tsr_3.loc[:, "cortical_aca_ctr"]
...
cortical_mca_ctr = tsr_3.loc[:, "cortical_mca_ctr"]
...
subcortical_aca_ctr = tsr_3.loc[:, "subcortical_aca_ctr"]
...
subcortical_mca_ctr = tsr_3.loc[:, "subcortical_mca_ctr"]
...
pca_cortex_ctr = tsr_3.loc[:, "pca_cortex_ctr"]
...
thalamus_ctr = tsr_3.loc[:, "thalamus_ctr"]
...
brainstem_ctr = tsr_3.loc[:, "brainstem_ctr"]
...
cerebellum_ctr = tsr_3.loc[:, "cerebellum_ctr"]
...
watershed_ctr = tsr_3.loc[:, "watershed_ctr"]
...
hemorrhagic_infarct_ctr = tsr_3.loc[:, "hemorrhagic_infarct_ctr"]
...
old_stroke_ctci = tsr_3.loc[:, "old_stroke_ctci"]
...
cortical_aca_ctl = tsr_3.loc[:, "cortical_aca_ctl"]
...
cortical_mca_ctl = tsr_3.loc[:, "cortical_mca_ctl"]
...
subcortical_aca_ctl = tsr_3.loc[:, "subcortical_aca_ctl"]
...
subcortical_mca_ctl = tsr_3.loc[:, "subcortical_mca_ctl"]
...
pca_cortex_ctl = tsr_3.loc[:, "pca_cortex_ctl"]
...
thalamus_ctl = tsr_3.loc[:, "thalamus_ctl"]
...
brainstem_ctl = tsr_3.loc[:, "brainstem_ctl"]
...
cerebellum_ctl = tsr_3.loc[:, "cerebellum_ctl"]
...
watershed_ctl = tsr_3.loc[:, "watershed_ctl"]
...
hemorrhagic_infarct_ctl = tsr_3.loc[:, "hemorrhagic_infarct_ctl"]
...
old_stroke_ctch = tsr_3.loc[:, "old_stroke_ctch"]
...
cortical_aca_mrir = tsr_3.loc[:, "cortical_aca_mrir"]
...
cortical_mca_mrir = tsr_3.loc[:, "cortical_mca_mrir"]
...
subcortical_aca_mrir = tsr_3.loc[:, "subcortical_aca_mrir"]
...
subcortical_mca_mrir = tsr_3.loc[:, "subcortical_mca_mrir"]
...
pca_cortex_mrir = tsr_3.loc[:, "pca_cortex_mrir"]
...
thalamus_mrir = tsr_3.loc[:, "thalamus_mrir"]
...
brainstem_mrir = tsr_3.loc[:, "brainstem_mrir"]
...
cerebellum_mrir = tsr_3.loc[:, "cerebellum_mrir"]
...
watershed_mrir = tsr_3.loc[:, "watershed_mrir"]
...
hemorrhagic_infarct_mrir = tsr_3.loc[:, "hemorrhagic_infarct_mrir"]
...
old_stroke_mrici = tsr_3.loc[:, "old_stroke_mrici"]
...
cortical_aca_mril = tsr_3.loc[:, "cortical_aca_mril"]
...
cortical_mca_mril = tsr_3.loc[:, "cortical_mca_mril"]
...
subcortical_aca_mril = tsr_3.loc[:, "subcortical_aca_mril"]
...
subcortical_mca_mril = tsr_3.loc[:, "subcortical_mca_mril"]
...
pca_cortex_mril = tsr_3.loc[:, "pca_cortex_mril"]
...
thalamus_mril = tsr_3.loc[:, "thalamus_mril"]
...
brainstem_mril = tsr_3.loc[:, "brainstem_mril"]
...
cerebellum_mril = tsr_3.loc[:, "cerebellum_mril"]
...
watershed_mril = tsr_3.loc[:, "watershed_mril"]
...
hemorrhagic_infarct_mril = tsr_3.loc[:, "hemorrhagic_infarct_mril"]
...
old_stroke_mrich = tsr_3.loc[:, "old_stroke_mrich"]
...
fahiid_parents_1 = tsr_3.loc[:, "fahiid_parents_1"]
...
fahiid_parents_2 = tsr_3.loc[:, "fahiid_parents_2"]
...
fahiid_parents_3 = tsr_3.loc[:, "fahiid_parents_3"]
...
fahiid_parents_4 = tsr_3.loc[:, "fahiid_parents_4"]
...
fahiid_brsi_1 = tsr_3.loc[:, "fahiid_brsi_1"]
...
fahiid_brsi_2 = tsr_3.loc[:, "fahiid_brsi_2"]
...
fahiid_brsi_3 = tsr_3.loc[:, "fahiid_brsi_3"]
...
fahiid_brsi_4 = tsr_3.loc[:, "fahiid_brsi_4"]
...
nihs_1a_in = tsr_3.loc[:, "nihs_1a_in"]
...
nihs_1b_in = tsr_3.loc[:, "nihs_1b_in"]
...
nihs_1c_in = tsr_3.loc[:, "nihs_1c_in"]
...
nihs_5al_in = tsr_3.loc[:, "nihs_5al_in"]
...
nihs_5br_in = tsr_3.loc[:, "nihs_5br_in"]
...
nihs_6al_in = tsr_3.loc[:, "nihs_6al_in"]
...
nihs_6br_in = tsr_3.loc[:, "nihs_6br_in"]
...
nihs_10_in = tsr_3.loc[:, "nihs_10_in"]
...
nihs_11_in = tsr_3.loc[:, "nihs_11_in"]
...
nihs_1a_out = tsr_3.loc[:, "nihs_1a_out"]
...
nihs_1b_out = tsr_3.loc[:, "nihs_1b_out"]
...
nihs_1c_out = tsr_3.loc[:, "nihs_1c_out"]
...
nihs_2_out = tsr_3.loc[:, "nihs_2_out"]
...
nihs_3_out = tsr_3.loc[:, "nihs_3_out"]
...
nihs_4_out = tsr_3.loc[:, "nihs_4_out"]
...
nihs_5al_out = tsr_3.loc[:, "nihs_5al_out"]
...
nihs_5br_out = tsr_3.loc[:, "nihs_5br_out"]
...
nihs_6al_out = tsr_3.loc[:, "nihs_6al_out"]
...
nihs_6br_out = tsr_3.loc[:, "nihs_6br_out"]
...
nihs_7_out = tsr_3.loc[:, "nihs_7_out"]
...
nihs_8_out = tsr_3.loc[:, "nihs_8_out"]
...
nihs_9_out = tsr_3.loc[:, "nihs_9_out"]
...
nihs_10_out = tsr_3.loc[:, "nihs_10_out"]
...
nihs_11_out = tsr_3.loc[:, "nihs_11_out"]
...
TSR_3_CLEANED = pd.DataFrame([height_nm ,  weight_nm ,  edu_id ,  pro_id ,  opc_id ,  ih_fl ,  ivtpamg_nm , hospitalised_time, 
