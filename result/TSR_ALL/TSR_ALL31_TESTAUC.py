...
if __name__ == '__main__':
    ...
    ### Logistic Regression
    pkl_path = os.path.join("..", "..", "model", "model_pickle", "MICE5", "TSR_ALL31G_LR_BASED.pkl")
    G_LR_BASED = joblib.load(pkl_path)

    pkl_path = os.path.join("..", "..", "model", "model_pickle", "MICE5", "TSR_ALL31G_LR_TUNED.pkl")
    G_LR_TUNED = joblib.load(pkl_path)

    pkl_path = os.path.join("..", "..", "model", "model_pickle", "MICE5", "TSR_ALL31G_LR_CALIBRATED.pkl")
    ...
    ### Logistic Regression
    pkl_path = os.path.join("..", "..", "model", "model_pickle", "MICE5", "TSR_ALL31B_LR_BASED.pkl")
    B_LR_BASED = joblib.load(pkl_path)

    pkl_path = os.path.join("..", "..", "model", "model_pickle", "MICE5", "TSR_ALL31B_LR_TUNED.pkl")
    B_LR_TUNED = joblib.load(pkl_path)

    pkl_path = os.path.join("..", "..", "model", "model_pickle", "MICE5", "TSR_ALL31B_LR_CALIBRATED.pkl")
