...
if __name__ == '__main__':
    ...
    csv_path = os.path.join("..", "..", "data", "LINKED_DATA", "TSR_ALL", "TSR_ALL1", "TSR_ALL1_X_VALIDATION.csv")
    X_validation = pd.read_csv(csv_path)

    csv_path = os.path.join("..", "..", "data", "LINKED_DATA", "TSR_ALL", "TSR_ALL1", "TSR_ALL1_y_VALIDATION.csv")
    ...
    ### XGBClassifier
    pkl_path = os.path.join("..", "..", "model", "model_pickle", "MICE5", "TSR_ALL1_XGBC_BASED.pkl")
    ...
    validation_auroc_list, validation_auroc_tuned_list, validation_auroc_cc_list, XGBC_CALIBRATED_selected = algorithms(X_train,
                                                                                                      ...
                                                                                                      XGBC_CALIBRATED,
                                                                                                      xgbc_selected)
    pkl_path = os.path.join("..", "..", "model", "model_pickle", "MICE5", "TSR_ALL1_XGBC_CALIBRATED_selected.pkl")
    ...
    plt.title('TSR_ALL1_XGBC', fontsize=15)
    # plt.savefig('PLOT/TSR_ALL1/TSR_ALL1_XGBC.png')
    plt.show()