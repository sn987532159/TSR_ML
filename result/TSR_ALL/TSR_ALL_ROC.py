...
ax[0, 0].plot(G1_fpr_list_cc_list[0], G1_tpr_list_cc_list[0], lw=1, label='XGBC-threshold$_\mathrm{min}$* (AUROC = %0.3f)' % 0.678)
...
ax[0, 0].set_title('ROC Curve of G$_\mathrm{d}$-1m',fontweight="bold", size=15)
ax[0, 0].legend(loc="lower right")

ax[0, 1].plot(B1_fpr_list_cc_list[0], B1_tpr_list_cc_list[0], lw=1, label='XGBC-threshold$_\mathrm{min}$* (AUROC = %0.3f)' % 0.816)
...
ax[0, 1].set_title('ROC Curve of P$_\mathrm{d}$-1m',fontweight="bold", size=15)
ax[0, 1].legend(loc="lower right")

ax[1, 0].plot(G31_fpr_list_cc_list[0], G31_tpr_list_cc_list[0], lw=1, label='XGBC-threshold$_\mathrm{min}$* (AUROC = %0.3f)' % 0.815)
...
ax[1, 0].set_title('ROC Curve of G$_\mathrm{d}$-3m',fontweight="bold", size=15)
ax[1, 0].legend(loc="lower right")

ax[1, 1].plot(B31_fpr_list_cc_list[0], B31_tpr_list_cc_list[0], lw=1, label='XGBC-threshold$_\mathrm{min}$* (AUROC = %0.3f)' % 0.919)
...
ax[1, 1].set_title('ROC Curve of P$_\mathrm{d}$-3m',fontweight="bold", size=15)
