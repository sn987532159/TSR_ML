...
if __name__ == '__main__':
    # Import datasets
    csv_path = os.path.join("..", "..", "data", "LINKED_DATA", "TSR_ALL", "TSR_ALL31", "TSR_ALL31_X_TRAIN.csv")
    X_train = pd.read_csv(csv_path)

    csv_path = os.path.join("..", "..", "data", "LINKED_DATA", "TSR_ALL", "TSR_ALL31", "TSR_ALL31_y_TRAIN.csv")
    y_train = pd.read_csv(csv_path)
    y_train = np.ravel(y_train)

    csv_path = os.path.join("..", "..", "data", "LINKED_DATA", "TSR_ALL", "TSR_ALL31", "TSR_ALL31_X_VALIDATION.csv")
    X_validation = pd.read_csv(csv_path)

    csv_path = os.path.join("..", "..", "data", "LINKED_DATA", "TSR_ALL", "TSR_ALL31", "TSR_ALL31_y_VALIDATION.csv")
    ...
    ### XGBClassifier
    pkl_path = os.path.join("..", "..", "model", "model_pickle", "MICE5", "TSR_ALL31_XGBC_BASED.pkl")
    XGBC_BASED = joblib.load(pkl_path)

    pkl_path = os.path.join("..", "..", "model", "model_pickle", "MICE5", "TSR_ALL31_XGBC_TUNED.pkl")
    XGBC_TUNED = joblib.load(pkl_path)

    pkl_path = os.path.join("..", "..", "model", "model_pickle", "MICE5", "TSR_ALL31_XGBC_CALIBRATED.pkl")
    ...
    validation_auroc_list, validation_auroc_tuned_list, validation_auroc_cc_list, XGBC_CALIBRATED_selected = algorithms(X_train,
                                                                                                      ...
                                                                                                      XGBC_CALIBRATED,
                                                                                                      xgbc_selected)
    pkl_path = os.path.join("..", "..", "model", "model_pickle", "MICE5", "TSR_ALL31_XGBC_CALIBRATED_selected.pkl")
    ...
    plt.title('TSR_ALL31_XGBC', fontsize=15)
    # plt.savefig('PLOT/TSR_ALL31/TSR_ALL31_XGBC.png')
    plt.show()