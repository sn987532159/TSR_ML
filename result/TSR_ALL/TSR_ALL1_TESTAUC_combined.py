...
if __name__ == '__main__':
    ...
    csv_path = os.path.join("..", "..", "data", "LINKED_DATA", "TSR_ALL", "TSR_ALL1", "TSR_ALL1_X_TEST.csv")
    X_test = pd.read_csv(csv_path)

    csv_path = os.path.join("..", "..", "data", "LINKED_DATA", "TSR_ALL", "TSR_ALL1", "TSR_ALL1_y_TEST.csv")
    ...
    test_auroc_list, test_auroc_tuned_list, test_auroc_cc_list, XGBC_CALIBRATED_selected = algorithms(X_train,
                                                                                                      ...
                                                                                                      XGBC_CALIBRATED,
                                                                                                      xgbc_selected)
    pkl_path = os.path.join( "..", "..", "model", "model", "model_pickle", "MICE5", "TSR_ALL1_XGBC_CALIBRATED_selected.pkl")
