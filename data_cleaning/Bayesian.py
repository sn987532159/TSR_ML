...
#G_X_train.columns = tsr_3_imp_mean.drop(["icase_id", "idcase_id", "mrs_tx_3"], axis=1).columns
...
#G_X_test.columns = tsr_3_imp_mean.drop(["icase_id", "idcase_id", "mrs_tx_3"], axis=1).columns
...
###Bayesian Search CV
bo_et = BayesSearchCV(estimator = ExtraTreesClassifier(random_state = 19, class_weight = {0: 20, 1: 1}, bootstrap = True, oob_score = True),
                      search_spaces = {"n_estimators": (10, 300),
                                       "max_depth": (10, 200),
...
bo_etCV = bo_et.fit(G_X_train_tl, G_y_train_tl)
print('--> Tuned Parameters Best Score: ', bo_etCV.best_score_)
print('--> Best Parameters: \n', bo_etCV.best_params_)