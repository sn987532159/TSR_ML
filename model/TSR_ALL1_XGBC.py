...
joblib.dump(xgbcG, "model_pickle/TSR_ALL1G_XGBC_BASED.pkl")

### TUNED XGBC
xgbcG_rsCV = xgbcG_rscv.fit(G_X_train, G_y_train)
joblib.dump(xgbcG_rsCV, "model_pickle/TSR_ALL1G_XGBC_TUNED.pkl")
...
joblib.dump(xgbcG_ccCV, "model_pickle/TSR_ALL1G_XGBC_CALIBRATED.pkl")
...
joblib.dump(xgbcB, "model_pickle/TSR_ALL1B_XGBC_BASED.pkl")

### TUNED XGBC
xgbcB_rsCV = xgbcB_rscv.fit(B_X_train, B_y_train)
joblib.dump(xgbcB_rsCV, "model_pickle/TSR_ALL1B_XGBC_TUNED.pkl")
...
joblib.dump(xgbcB_ccCV, "model_pickle/TSR_ALL1B_XGBC_CALIBRATED.pkl")