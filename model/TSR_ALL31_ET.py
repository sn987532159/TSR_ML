...
joblib.dump(etB, "model_pickle/TSR_ALL31B_ET_BASED.pkl")

### TUNED ET
etB_rsCV = etB_rscv.fit(B_X_train, B_y_train)
joblib.dump(etB_rsCV, "model_pickle/TSR_ALL31B_ET_TUNED.pkl")

### CALIBRATED ET
etB_cccv = CalibratedClassifierCV(base_estimator=etB_rsCV.best_estimator_, cv=5)
etB_ccCV = etB_cccv.fit(B_X_train, B_y_train)
joblib.dump(etB_ccCV, "model_pickle/TSR_ALL31B_ET_CALIBRATED.pkl")