...
joblib.dump(xgbcG_rsCV, "model_pickle/MICE5/TSR_ALL3G_XGBC_TUNED.pkl")
...
joblib.dump(xgbcB_rsCV, "model_pickle/MICE5/TSR_ALL3B_XGBC_TUNED.pkl")
...
joblib.dump(xgbcB_ccCV, "model_pickle/MICE5/TSR_ALL3B_XGBC_CALIBRATED.pkl")