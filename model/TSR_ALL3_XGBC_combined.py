...
joblib.dump(xgbc, "model_pickle/MICE1/TSR_ALL3_XGBC_BASED.pkl")

### TUNED XGBC
xgbc_rsCV = xgbc_rscv.fit(X_train, y_train)
joblib.dump(xgbc_rsCV, "model_pickle/MICE1/TSR_ALL3_XGBC_TUNED.pkl")

### CALIBRATED XGBC
xgbc_cccv = CalibratedClassifierCV(base_estimator=xgbc_rsCV.best_estimator_, cv=5)
xgbc_ccCV = xgbc_cccv.fit(X_train, y_train)
joblib.dump(xgbc_ccCV, "model_pickle/MICE1/TSR_ALL3_XGBC_CALIBRATED.pkl")